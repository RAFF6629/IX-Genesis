...
const Sabtu = React.lazy(() => import("../components/Mapel/Sabtu")); // Corrected this line
...
const Schedule = () => {
    ...
    const piketGroup = [
        ["EXCEEL", "LANGIT", "VINCENT", "MARSELLA", "ARISTA", "NOVA"],
        ["KHOLIQ", "RAFSAN", "SATRIO", "GALUH", "BELINDA", "VALENCIA"],
        ["DHANU", "VALERIL", "ZAHRA", "GENDHIS", "FANESHA"],
        ["IRFAN", "DAVIN", "AIRA", "RAISYA", "ZILVA", "ZARUS"],
        ["FEBRI", "DIANA", "RADEN", "KESYA", "RAFAEL"],
        ["IMA", "NATA", "NEINI", "DITA"],
    ];
